...
**ตัวอย่างผลลัพธ์:**
| ปี | เดือน | ชื่อเดือน | เมนูขายดีที่สุด | หมวดหมู่ | จำนวนที่ขาย | ยอดขาย | จำนวนออเดอร์ | สถานะ |
|----|-------|----------|----------------|----------|-------------|---------|--------------|-------|
| 2025 | 10 | ตุลาคม | Club Sandwich | อาหาร | 17 | ฿2,040.00 | 10 | 📊 ขายน้อย |
| 2025 | 9 | กันยายน | น้ำส้ม | เครื่องดื่มเย็น | 12 | ฿900.00 | 2 | 📊 ขายน้อย |

**การใช้งาน:**
- ดูเมนูยอดนิยมในแต่ละเดือน
- วางแผนโปรโมชั่นตามฤดูกาล
- วิเคราะห์เทรนด์สินค้า

**เทคนิค SQL ที่ใช้:**
- **CTE (Common Table Expression)**: ใช้ WITH clause เพื่อแยก logic
- **Window Function**: ใช้ RANK() OVER() จัดอันดับแต่ละเดือน
- **PARTITION BY**: แบ่งกลุ่มตามปีและเดือน

---

### 37. ยอดขายรายเดือนของพนักงาน (Staff Monthly Sales)

**API Endpoint:** `api/reports.php?type=staff_monthly_sales`

**คำอธิบาย:**
แสดงยอดขายและประสิทธิภาพของพนักงานแต่ละคนในแต่ละเดือน พร้อมการประเมินผลงาน
...
**ตัวอย่างผลลัพธ์:**
| ชื่อพนักงาน | ตำแหน่ง | ปี | เดือน | ชื่อเดือน | จำนวนออเดอร์ | ยอดขายรวม | ออเดอร์เฉลี่ย | จำนวนวันทำงาน | ยอดขายต่อวัน | ระดับผลงาน |
|------------|---------|----|----|----------|-------------|-----------|-------------|---------------|--------------|-----------|
| สมชาย ใจดี | cashier | 2025 | 10 | ตุลาคม | 16 | ฿5,000.00 | ฿312.50 | 2 | ฿2,500.00 | ⭐ ดีมาก |
| วิชัย ชงเก่ง | barista | 2025 | 10 | ตุลาคม | 1 | ฿600.00 | ฿600.00 | 1 | ฿600.00 | 📊 ปกติ |
| สมชาย ใจดี | cashier | 2025 | 9 | กันยายน | 10 | ฿1,870.00 | ฿187.00 | 4 | ฿467.50 | 📊 ปกติ |

**การใช้งาน:**
- ประเมินผลงานพนักงานรายเดือน
- เปรียบเทียบประสิทธิภาพระหว่างพนักงาน
- วางแผนโบนัสหรือรางวัล
- ตรวจสอบการทำงานของพนักงานแต่ละคน

**Filter Parameters:**
- `staff_name`: ชื่อพนักงาน
- `start_date`, `end_date`: ช่วงวันที่
- `month`: เดือนเฉพาะ (1-12)

**เกณฑ์การประเมิน:**
- 🏆 **ยอดเยี่ยม**: ยอดขายรวม >= ฿10,000
- ⭐ **ดีมาก**: ยอดขายรวม >= ฿5,000
- 👍 **ดี**: ยอดขายรวม >= ฿2,000
- 📊 **ปกติ**: ยอดขายรวม < ฿2,000

---

## 🎯 สรุปรายงานทั้งหมดในระบบ

### รายงานสินค้า (Product Reports)
1. สินค้าขายดี (Top Products)
2. สรุปยอดขายสินค้า (Product Summary)
3. รายงานสต็อก (Product Inventory)
4. เปรียบเทียบหมวดหมู่ (Product Comparison)
5. ประสิทธิภาพสินค้า (Product Performance)
6. เทรนด์สินค้า (Product Trends)
7. สินค้าขายช้า (Slow Moving Products)
8. จำนวนเมนูแต่ละเดือน (Monthly Menu Count)
9. **เมนูขายดีแต่ละเดือน (Top Menu by Month)** ✨ NEW

### รายงานยอดขาย (Sales Reports)
10. ยอดขายรายวัน (Daily Sales)
11. ยอดขายรายเดือน (Monthly Sales)
12. การชำระเงิน (Payment Analysis)
13. รูปแบบออเดอร์ (Order Patterns)
14. ขนาดออเดอร์ (Order Size Analysis)
15. ช่วงเวลายอดนิยม (Peak Hours)
16. วันที่ขายดี (Best Day)

### รายงานพนักงาน (Staff Reports)
17. อันดับพนักงาน (Staff Ranking)
18. ผลงานพนักงาน (Staff Performance)
19. สินค้าที่พนักงานขาย (Staff Products)
20. ออเดอร์ต่อพนักงาน (Staff Orders)
21. **รายละเอียดออเดอร์พนักงาน (Staff Order Details)** ✨ NEW
22. ประสิทธิภาพพนักงาน (Staff Efficiency)
23. เปรียบเทียบพนักงาน (Staff Comparison)
24. ลูกค้าต่อพนักงาน (Staff Customers)
25. **ยอดขายรายเดือนของพนักงาน (Staff Monthly Sales)** ✨ NEW

### รายงานลูกค้า (Customer Reports)
26. วิเคราะห์ลูกค้า (Customer Analysis)
27. รายงานขั้นสูง (Advanced Queries)
