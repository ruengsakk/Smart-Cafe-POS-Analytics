...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- Report Tabs -->
<!-- Report Tabs -->        <div class="report-tabs">            <ul class="nav nav-pills nav-fill" id="staffReportTabs" role="tablist">                <li class="nav-item" role="presentation">                    <button class="nav-link active" id="staff-ranking-tab" data-bs-toggle="pill" data-bs-target="#staff-ranking" type="button">                        <i class="fas fa-trophy"></i> อันดับพนักงาน                                    </li>                <li class="nav-item" role="presentation">                    <button class="nav-link" id="staff-performance-tab" data-bs-toggle="pill" data-bs-target="#staff-performance" type="button">                        <i class="fas fa-user-tie"></i> ผลงานพนักงาน                                    </li>                <li class="nav-item" role="presentation">                    <button class="nav-link" id="staff-comparison-tab" data-bs-toggle="pill" data-bs-target="#staff-comparison" type="button">                        <i class="fas fa-balance-scale"></i> เปรียบเทียบพนักงาน                                    </li>            </ul>        </div>        <!-- Tab Content -->        <div class="tab-content" id="staffReportContent">            <!-- Staff Ranking -->            <div class="tab-pane fade show active" id="staff-ranking" role="tabpanel">                <div class="card">                    <div class="card-header">                        <h5><i class="fas fa-trophy"></i> อันดับพนักงานยอดเยี่ยม</h5>                    </div>                    <div class="card-body">                        
            ...
            <div class="tab-pane fade" id="staff-orders" role="tabpanel">
                <div class="card">
                    <div class="card-header">
                        <h5><i class="fas fa-receipt"></i> ออเดอร์ที่พนักงานรับผิดชอบ</h5>
                    </div>
                    <div class="card-body">
